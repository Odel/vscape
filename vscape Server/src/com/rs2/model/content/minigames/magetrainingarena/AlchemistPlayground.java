...
/**
 * Created by IntelliJ IDEA. User: vayken Date: 31/12/11 Time: 11:14 To change
 * this template use File | Settings | File Templates.
 */
public class AlchemistPlayground {// todo guardian yelling
	...
	public boolean isInAlchemistPlayGround() {
		...
		return player.getPosition().getZ() == 2 && x >= 3355 && x <= 3390 && y >= 9600 && y <= 9665;
	...
	public void loadInterfacePlayer() {
		...
		player.getActionSender().sendString("" + adamantKitePrice, 15903);// adamant
																			// kiteshield
		player.getActionSender().sendString("" + adamantMedHelmPrice, 15904);// adamant
																				// med
	...
	private void handleCupBoard(final int objectId, final int objectX, final int objectY) { // todo
																							// this
																							// tick
																							// is
																							// sent
	...
	public void alchemyItem(int itemId) {
