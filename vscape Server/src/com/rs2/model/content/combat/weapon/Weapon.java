...
public enum Weapon {
    ...
    JAVELIN(WeaponInterface.THROWING, RangedAmmoType.JAVELIN, 6, new int[]{806, 806, 806}, Constants.MOVEMENT_ANIMS, 424),
    THROWING_AXE(WeaponInterface.THROWING, RangedAmmoType.THROWNAXE, 5, new int[]{806, 806, 806}, Constants.MOVEMENT_ANIMS, 424),
    ...
    OBBY_STAFF(WeaponInterface.STAFF, 6, new int[]{406, 407, 408}, Constants.MOVEMENT_ANIMS, 410),
