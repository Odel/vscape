...
public enum RangedAmmo {
	...
	DIAMOND_BOLTS(27, 28, 105), DRAGONSTONE_BOLTS(27, 28, 117), ONYX_BOLTS(27, 28, 120),
	BRONZE_BOLTS(27, 28, 10), IRON_BOLTS(27, 28, 46), STEEL_BOLTS(27, 28, 64), BLACK_BOLTS(27, 28, 75), MITHRIL_BOLTS(27, 28, 82), ADAMANT_BOLTS(27, 28, 100), RUNITE_BOLTS(27, 28, 115),
	
	/* Obby rings */
	TOKTZ(442, -1, 49);

	static RangedAmmo[] BOLT_AMMO = {BARBED_BOLTS, BRONZE_BOLTS, IRON_BOLTS, STEEL_BOLTS, BLACK_BOLTS, MITHRIL_BOLTS, ADAMANT_BOLTS, RUNITE_BOLTS, OPAL_BOLTS, JADE_BOLTS, PEARL_BOLTS, TOPAZ_BOLTS, SAPPHIRE_BOLTS, EMERALD_BOLTS, RUBY_BOLTS, DIAMOND_BOLTS, DRAGONSTONE_BOLTS, ONYX_BOLTS};
