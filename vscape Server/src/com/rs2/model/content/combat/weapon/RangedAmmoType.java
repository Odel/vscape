...
public enum RangedAmmoType {
	ARROW(Constants.ARROWS, 90, ProjectileTrajectory.ARROW, ARROW_AMMO), CRYSTAL(Constants.ARROWS, 90, ProjectileTrajectory.CRYSTAL, new RangedAmmo[] {RangedAmmo.CRYSTAL_ARROW} ), OBBY_RING(Constants.WEAPON, 90, ProjectileTrajectory.ARROW, new RangedAmmo[]{RangedAmmo.TOKTZ}), KNIFE(Constants.WEAPON, 90, ProjectileTrajectory.KNIFE, KNIFE_AMMO), JAVELIN(Constants.WEAPON, 90, ProjectileTrajectory.ARROW, JAVELIN_AMMO), DART(Constants.WEAPON, 90, ProjectileTrajectory.DART, DART_AMMO), OGRE(Constants.ARROWS, 90, ProjectileTrajectory.ARROW, new RangedAmmo[]{OGRE_ARROW}), BRUTAL(Constants.ARROWS, 90, ProjectileTrajectory.ARROW, BRUTAL_AMMO), THROWNAXE(Constants.WEAPON, 90, ProjectileTrajectory.ARROW, THROWNAXE_AMMO), BOLTS(Constants.ARROWS, 90, ProjectileTrajectory.ARROW, new RangedAmmo[]{RangedAmmo.BOLTS, RangedAmmo.BARBED_BOLTS}), KARILS_BOLT(Constants.ARROWS, 90, ProjectileTrajectory.ARROW, new RangedAmmo[]{RangedAmmo.BOLT_RACK});
