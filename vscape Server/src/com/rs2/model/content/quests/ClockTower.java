...
public class ClockTower implements Quest{
	...
	public void SpindlesFilled(Player player) {
		if(cogPlaced(player.getQuestVars().getBlackCogPlaced()) && cogPlaced(player.getQuestVars().getRedCogPlaced()) && cogPlaced(player.getQuestVars().getBlueCogPlaced()) && cogPlaced(player.getQuestVars().getWhiteCogPlaced())) {
