...
import static com.rs2.model.content.quests.impl.TheGrandTree.PLACE_ANIM;
...
public class TheGolem implements Quest {
    ...
    public void sendQuestRequirements(Player player) {
         ...
         * Remember if there is no new persistent entry for that stage, stack
         * the case with the last case that started the newest persistent entry,
         * to keep lastIndex correct
         **/
            case QUEST_STARTED:
                lastIndex = 3;
                break;
