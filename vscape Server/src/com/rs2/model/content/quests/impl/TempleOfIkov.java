...
public class TempleOfIkov implements Quest {
	...
	public static final int questIndex = 7378; //Used in player's quest log interface, id is in Player.java, Change
	//Quest stages
		...
		CycleEventHandler.getInstance().addEvent(player, new CycleEvent() {
			...
			public void execute(CycleEventContainer b) {
				...
				case 3:
					...
					int attackerX = spawnPos.getX(), attackerY = spawnPos.getY();
