			...
			case 922 : //aggie
			   switch(player.getDialogue().getChatId()) {
				...
				case 3 :
				    ...
				    return true;
				case 4 :
				    player.getDialogue().sendStatement("Aggie hands you a list of supplies:", "Ash, flour, a bucket of water, and redberries for the dwarf.");
				    return true;
				case 5 :
				...
				case 10 :
				    ...
				    return true;
				case 11 :
				    player.getDialogue().sendStatement("Aggie hands you the completed paste.");
				...
				case 12 :
				    ...
				    return true;
				case 13 :
				    player.getDialogue().sendNpcChat("Ack ack ack! I only have yellow dye", "for sale on the fly!", LAUGHING);
				    return true;
				case 14 :
				    player.getDialogue().sendPlayerChat("Erm, okay, that's just what I need.", CONTENT);
				    return true;
				case 15 :
				    player.getDialogue().sendNpcChat("I need 2 onions and 5 coins!", LAUGHING);
				    return true;
				case 16 :
				    if(player.getInventory().playerHasItem(1957, 2) && player.getInventory().playerHasItem(995, 5)) {
					player.getDialogue().sendStatement("You hand Aggie the supplies for a yellow dye.");
				...
				case 17 :
				    ...
				    return true;
				case 18 :
				    player.getDialogue().sendNpcChat("Here you are! Don't run too far! Ack ack ack!", LAUGHING);
				    player.getInventory().addItem(new Item(1765));
				    player.getDialogue().endDialogue();
				    return true;
				case 25 :
				    player.getDialogue().sendStatement("Aggie hands you a list of supplies:", "Ash, flour, a bucket of water, and some redberries.");
				    player.getDialogue().endDialogue();
				    return true;
			...
			case 736 : //emily the bartender
			    switch(player.getDialogue().getChatId()) {
					...
					/*case 4 :
						...
						player.getDialogue().sendNpcChat("You cheap bastard!", "You don't have the coin!", ANGRY_2);
						player.getDialogue().endDialogue();
						return true;
					    }
					case 5 :
