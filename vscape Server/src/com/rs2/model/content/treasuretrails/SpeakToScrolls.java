...
public class SpeakToScrolls {
	...
	public static enum SpeakToData {
		...
		NPC_30(new String[]{"This aviator is at the ", "peak of his profession"}, 3580, 3810, "Puzzle", 3),
		NPC_31(new String[]{"Citric Cellar", ""}, 2792, 603, "Puzzle", 3),
		NPC_32(new String[]{"Generally ", "speaking, his ", "nose was very ", "bent"}, 2783, 4493, "Puzzle", 3),
	...
	public static boolean handleNpc(Player player, int npcId) {
		...
		if (speakData.getToGet().equals("Challenge")) {
