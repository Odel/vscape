...
public class OneIngredients {
	...
	public static enum MixItemData {
		PIE_SHELL(1953, 0, 2313, 2315, 1, 0, true, 0), REDBERRY_PIE(1951, 0, 2315, 2321, 10, 78, true, 0), APPLE_PIE(1955, 0, 2315, 2317, 30, 130, true, 0), MEAT_PIE(2142, 0, 2315, 2319, 20, 110, true, 0), CURRY(2007, 0, 1921, 2009, 60, 280, true, 7496), CURRY_LEAF(5970, 3, 1921, 2009, 60, 280, true, 0),

		MEAT_PIZZA(2142, 0, 2289, 2293, 45, 169, true, 0), ANCHOVIE_PIZZA(319, 0, 2289, 2297, 45, 169, true, 0), PINEAPPLE_PIZZA(2116, 0, 2289, 2301, 65, 195, true, 0), PINEAPPLE_PIZZA2(2118, 0, 2289, 2301, 65, 195, true, 0),

		CHOCOLATE_CAKE(1973, 0, 1891, 1897, 50, 210, true, 0), CHOCOLATE_CAKE2(1975, 0, 1891, 1897, 50, 210, true, 0), CHOCOLATE_MILK(1975, 0, 1927, 1977, 4, 0, true, 0), CAKE1(2516, 0, 1887, 1889, 40, 0, true, 0), CAKE2(1927, 0, 1887, 1889, 40, 0, true, 0), CAKE3(1944, 0, 1887, 1889, 40, 0, true, 0),

		SPICY_SAUCE(1550, 0, 1923, 7074, 9, 25, true, 0), SPICY_SAUCE2(2169, 0, 7074, 7072, 9, 25, true, 0), CON_CARNE(2142, 0, 7072, 7062, 11, 55, true, 0), SCRAMBLED_EGG(1944, 0, 1923, 7076, 13, 50, true, 0), SCRAMBLED_EGG_AND_TOMATO(1982, 0, 7078, 7064, 23, 50, true, 0), FRIED_ONION(1957, 0, 1923, 1871, 42, 60, true, 0), FRIED_MUSHROOM(6004, 0, 1923, 7080, 46, 60, true, 0), MUSHROOM_AND_ONION(7082, 0, 7084, 7066, 57, 120, false, 1923),

		POTATO_WITH_BUTTER(6697, 0, 6705, 6703, 39, 95.5, false, 1923), CHILLI_POTATO(6703, 0, 7062, 7054, 41, 165.5, false, 1923), CHEESE_POTATO(6703, 0, 1985, 6705, 47, 199.5, false, 1923), EGG_POTATO(6703, 0, 7064, 7056, 51, 195.5, false, 1923), MUSHROOM_AND_ONION_POTATO(7082, 0, 7066, 7058, 64, 270.5, false, 1923), TUNA_POTATO(6703, 0, 7068, 7060, 68, 309.5, false, 1923), WINE(1987, 0, 1937, 1993, 35, 309.5, false, 0), NETTLE(4241, 0, 1921, 4237, 20, 52, false, 0), NETTLE_TEA(4239, 0, 1980,
				4242, 20, 52, false, 1923), ;
