...
public class Cooking {
	...
	public static enum CookingItems { // raw cooked burnt level exp burn
		...
		APPLE_PIE(2317, 2323, 2329, 30, 130, 35, 35, false),
		...
		SARDINE(327, 325, 369, 1, 40, 38, 38, true), 
		ANCHOVIES(321, 319, 323, 1, 30, 34, 34, true),
		HERRING(345, 347, 357, 5, 50, 37, 37, true), 
		MACKEREL(353, 355, 357, 10, 60, 35, 35, true), 
		TROUT(335, 333, 343, 15, 70, 50, 50, true), 
		COD(341, 339, 343, 17, 75, 39, 39, true), 
		PIKE(349, 351, 343, 20, 80, 52, 52, true), 
		SALMON(331, 329, 343, 25, 90, 58, 58, true),
		SLIMY_EEL(3379, 3381, 3383, 28, 95, 58, 58, true),
		TUNA(359, 361, 367, 30, 100, 65, 65, true), 
		KARAMBWAN(3142, 3144, 3148, 30, 190, 100, 100, true), 
		CAVE_EEL(5001, 5003, 5002, 38, 115, 40, 40, true),
		LOBSTER(377, 379, 381, 40, 120, 74, 66, true),
