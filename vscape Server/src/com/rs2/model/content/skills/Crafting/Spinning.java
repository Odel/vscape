...
public class Spinning {
	...
	public static enum SpinningWheel {
		WOOL(34185, 1737, 1759, 1, 1, 2.5),
        WOOL5(34184, 1737, 1759, 5, 1, 2.5),
        WOOL10(34183, 1737, 1759, 10, 1, 2.5),
        WOOLX(34182, 1737, 1759, 0, 1, 2.5),
        FLAX(34189, 1779, 1777, 1, 10, 15),
        FLAX5(34188, 1779, 1777, 5, 10, 15),
        FLAX10(34187, 1779, 1777, 10, 10, 15),
        FLAXX(34186, 1779, 1777, 0, 10, 15),
        ROOT(34193, 6051, 6038, 1, 19, 30),
        ROOT5(34192, 6051, 6038, 5, 19, 30),
        ROOT10(34191, 6051, 6038, 10, 19, 30),
        ROOTX(34190, 6051, 6038, 0, 19, 30);
