...
public class ItemOnItemHandling {
	...
	public enum ItemOnItem {
		...
		TORCH(590, 596, new Item[]{new Item(596)}, new Item[]{new Item(594)}, -1, new int[]{Skill.FIREMAKING, 1}, 0, "You lit the torch."), CANDLE(590, 36, new Item[]{new Item(36)}, new Item[]{new Item(33)}, -1, new int[]{Skill.FIREMAKING, 1}, 0, "You lit the candle."), BLACK_CANDLE(590, 38, new Item[]{new Item(38)}, new Item[]{new Item(32)}, -1, new int[]{Skill.FIREMAKING, 1}, 0, "You lit the black candle."),

		CANDLE_LANTERN1(36, 4527, new Item[]{new Item(36), new Item(4527)}, new Item[]{new Item(4529)}, -1, null, 0, null), CANDLE_LANTERN(590, 4529, new Item[]{new Item(4529)}, new Item[]{new Item(4531)}, -1, new int[]{Skill.FIREMAKING, 4}, 0, "You lit the candle lantern."),

		BLACK_CANDLE_LANTERN1(38, 4527, new Item[]{new Item(38), new Item(4527)}, new Item[]{new Item(4532)}, -1, null, 0, null), BLACK_CANDLE_LANTERN(590, 4532, new Item[]{new Item(4532)}, new Item[]{new Item(4534)}, -1, new int[]{Skill.FIREMAKING, 4}, 0, "You lit the black candle lantern."),

		OIL_LAMP1(277, 4525, new Item[]{new Item(4525)}, new Item[]{new Item(4522)}, -1, null, 0, null), OIL_LAMP(590, 4522, new Item[]{new Item(4522)}, new Item[]{new Item(4524)}, -1, new int[]{Skill.FIREMAKING, 12}, 0, "You lit the oil lamp."), OIL_LANTERN1(277, 4535, new Item[]{new Item(4535)}, new Item[]{new Item(4537)}, -1, new int[]{Skill.FIREMAKING, 1}, 0, null), OIL_LANTERN2(4540, 4542, new Item[]{new Item(4540), new Item(4542)}, new Item[]{new Item(4535)}, -1, null, 0, null), OIL_LANTERN(590, 4537, new Item[]{new Item(4537)}, new Item[]{new Item(4539)}, -1, new int[]{Skill.FIREMAKING, 26}, 0, "You lit the oil lantern."),

		BULLSEYE_LANTERN1(4544, 4542, new Item[]{new Item(4544), new Item(4542)}, new Item[]{new Item(4546)}, -1, null, 0, null), BULLSEYE_LANTERN2(277, 4546, new Item[]{new Item(4546)}, new Item[]{new Item(4548)}, -1, null, 0, null), BULLSEYE_LANTERN(590, 4548, new Item[]{new Item(4548)}, new Item[]{new Item(4550)}, -1, new int[]{Skill.FIREMAKING, 49}, 0, "You lit the bullseye lantern."),

		MINING_HELMET(590, 5014, new Item[]{new Item(5014)}, new Item[]{new Item(5013)}, -1, new int[]{Skill.FIREMAKING, 65}, 0, "You lit the mining helmet."), 
