...
public enum Spell {
	...
	SMOKE_RUSH(50, 1978, null, 31, new Item[]{new Item(562, 2), new Item(560, 2), new Item(554), new Item(556)}, magicHit(14, magicProjectile(386), Graphic.lowGraphic(387)), true, null, new PoisonEffect(2)), SHADOW_RUSH(52, 1978, null, 31, new Item[]{new Item(562, 2), new Item(560, 2), new Item(556), new Item(566)}, magicHit(14, magicProjectile(378), Graphic.lowGraphic(379)), true, null, new StatEffect(Skill.ATTACK, .1)), BLOOD_RUSH(56, 1978, null, 33, new Item[]{new Item(562, 2), new Item(560, 2), new Item(565)}, magicHit(15, magicProjectile(372), Graphic.lowGraphic(373)), true, null, new LeechEffect(.4)), ICE_RUSH(58, 1978, null, 36, new Item[]{new Item(562, 2), new Item(560, 2), new Item(555, 2)}, magicHit(16, magicProjectile(360), Graphic.lowGraphic(361)), true, null, new BindingEffect(8)), SMOKE_BURST(62, 1979, null, 36, new Item[]{new Item(562, 4), new Item(560, 2), new Item(554, 2), new Item(556, 2)}, magicHit(17, magicProjectile(-1), Graphic.lowGraphic(390)), true, null,
			...
			null, 51, new Item[]{new Item(560, 4), new Item(565, 4), new Item(566)}, magicHit(29, magicProjectile(-1), Graphic.lowGraphic(377)), true, null, new LeechEffect(.4)), ICE_BARRAGE(94, 1979, null, 42, new Item[]{new Item(560, 4), new Item(565, 2), new Item(555, 6)}, magicHit(30, magicProjectile(-1), Graphic.lowGraphic(369)), true, null, new BindingEffect(33)),

	// ancient teleports
	PADDEWWA(54, 1979, Graphic.lowGraphic(392), 64, new Item[]{new Item(563, 2), new Item(554, 1), new Item(556, 1)}), SENNTISTEN(60, 1979, Graphic.lowGraphic(392), 70, new Item[]{new Item(563, 2), new Item(566, 1)}), KHARYRLL(66, 1979, Graphic.lowGraphic(392), 76, new Item[]{new Item(563, 2), new Item(565, 1)}), LASSAR(72, 1979, Graphic.lowGraphic(392), 82, new Item[]{new Item(563, 2), new Item(555, 4)}), DAREEYAK(78, 1979, Graphic.lowGraphic(392), 88, new Item[]{new Item(563, 2), new Item(554, 3), new Item(556, 2)}), CARRALLANGAR(84, 1979, Graphic.lowGraphic(392), 84, new Item[]{new Item(563, 2), new Item(566, 2)}), ANNAKARL(90, 1979, Graphic.lowGraphic(392), 100, new Item[]{new Item(563, 1), new Item(565, 1)}), GHORROCK(96, 1979, Graphic.lowGraphic(392), 106, new Item[]{new Item(563, 2), new Item(565, 8)}),

	// special spells
	IBAN_BLAST(50, 708, Graphic.highGraphic(87), 42, new Item[]{new Item(554, 5), new Item(560)}, magicHit(25, magicProjectile(88), Graphic.highGraphic(89)), true), CONFUSE(3, 716, Graphic.highGraphic(102), 13, new Item[]{new Item(555, 3), new Item(557, 2), new Item(559, 1)}, magicHit(-1, magicProjectile(103), Graphic.highGraphic(104)), true, new StatEffect(Skill.ATTACK, .05), null), WEAKEN(11, 716, Graphic.highGraphic(105), 20, new Item[]{new Item(555, 3), new Item(557, 2), new Item(559, 1)}, magicHit(-1, magicProjectile(106), Graphic.highGraphic(107)), true, new StatEffect(Skill.STRENGTH, .05), null), CURSE(19, 717, Graphic.highGraphic(108), 29, new Item[]{new Item(555, 2), new Item(557, 3), new Item(559, 1)}, magicHit(-1, magicProjectile(109), Graphic.highGraphic(110)), true, new StatEffect(Skill.DEFENCE, .05), null), VULNERABILITY(66, 729, Graphic.highGraphic(167), 76, new Item[]{new Item(557, 5), new Item(555, 5), new Item(566, 2)}, magicHit(-1, magicProjectile(168),
			Graphic.highGraphic(169)), true, new StatEffect(Skill.DEFENCE, .1), null), ENFEEBLE(73, 729, Graphic.highGraphic(170), 83, new Item[]{new Item(557, 8), new Item(555, 8), new Item(566, 2)}, magicHit(-1, magicProjectile(171), Graphic.highGraphic(172)), true, new StatEffect(Skill.STRENGTH, .1), null), STUN(80, 729, Graphic.highGraphic(173), 90, new Item[]{new Item(557, 12), new Item(555, 12), new Item(566, 2)}, magicHit(-1, magicProjectile(174), Graphic.highGraphic(107)), true, new StatEffect(Skill.ATTACK, .1), null), BIND(20, 711, Graphic.highGraphic(177), 30, new Item[]{new Item(557, 3), new Item(555, 3), new Item(561, 2)}, magicHit(-1, magicProjectile(178), Graphic.highGraphic(181)), true, new BindingEffect(8), null), SNARE(50, 711, Graphic.highGraphic(177), 60, new Item[]{new Item(557, 4), new Item(555, 4), new Item(561, 2)}, magicHit(2, magicProjectile(178), Graphic.highGraphic(180)), true, new BindingEffect(17), null), ENTANGLE(79, 711, Graphic.highGraphic(177), 90,
			new Item[]{new Item(557, 5), new Item(555, 5), new Item(561, 2)}, magicHit(5, magicProjectile(178), Graphic.highGraphic(179)), true, new BindingEffect(25), null), CRUMBLE_UNDEAD(39, 724, Graphic.highGraphic(146), 90, new Item[]{new Item(556, 2), new Item(557, 2), new Item(562, 1)}, magicHit(15, magicProjectile(146), Graphic.highGraphic(147)), true), MAGIC_DART(50, 1576, Graphic.highGraphic(327), 30, new Item[]{new Item(560, 1), new Item(558, 4)}, magicHit(10, magicProjectile(328), Graphic.highGraphic(329)), true), SARADOMIN_STRIKE(50, 811, null, 60, new Item[]{new Item(554, 2), new Item(565, 2), new Item(556, 4)}, magicHit(20, null, Graphic.highGraphic(76)), true), CLAWS_OF_GUTHIX(60, 811, null, 60, new Item[]{new Item(554, 1), new Item(565, 2), new Item(556, 4)}, magicHit(20, null, Graphic.highGraphic(77)), true), FLAMES_OF_ZAMORAK(60, 811, null, 60, new Item[]{new Item(554, 4), new Item(565, 2), new Item(556, 1)}, magicHit(20, null, Graphic.lowGraphic(78)), true), TELEBLOCK(
			85, 1819, null, 65, new Item[]{new Item(563, 1), new Item(562, 1), new Item(560, 1)}, magicHit(-1, magicProjectile(344), Graphic.lowGraphic(345)), true, new TbEffect(500), null),

	// misc spells
	CHARGE(80, 811, Graphic.highGraphic(301), 0, new Item[]{new Item(554, 3), new Item(565, 3), new Item(556, 3)}), LOW_ALCH(21, 712, Graphic.highGraphic(112), 31, new Item[]{new Item(554, 3), new Item(561, 1)}), HIGH_ALCH(55, 713, Graphic.highGraphic(113), 65, new Item[]{new Item(554, 5), new Item(561, 1)}), TELEGRAB(33, 728, Graphic.highGraphic(142), 35, new Item[]{new Item(556, 1), new Item(563, 1)}, magicHit(-1, magicProjectile(143), new Graphic(144, 0)), false), CHARGE_WATER(56, 726, Graphic.highGraphic(149), 66, new Item[]{new Item(555, 3), new Item(564, 3)}), CHARGE_EARTH(60, 726, Graphic.highGraphic(150), 70, new Item[]{new Item(557, 3), new Item(564, 3)}), CHARGE_FIRE(63, 726, Graphic.highGraphic(151), 73, new Item[]{new Item(554, 3), new Item(564, 3)}), CHARGE_AIR(66, 726, Graphic.highGraphic(152), 75, new Item[]{new Item(556, 3), new Item(564, 3)}), BONES_TO_BANANA(15, 722, Graphic.highGraphic(141), 75, new Item[]{new Item(557, 2), new Item(555, 2), new Item(561)}), SUPERHEAT(
			43, 725, Graphic.highGraphic(148), 53, new Item[]{new Item(554, 4), new Item(561, 1)}), BONES_TO_PEACH(60, 722, Graphic.highGraphic(311), 75, new Item[]{new Item(561, 2), new Item(555, 4), new Item(557, 4)}),

	ENCHANT_LV_1(7, 719, Graphic.highGraphic(114), 18, new Item[]{new Item(555, 1), new Item(564)}), ENCHANT_LV_2(27, 719, Graphic.highGraphic(114), 37, new Item[]{new Item(556, 3), new Item(564)}), ENCHANT_LV_3(49, 720, Graphic.highGraphic(115), 59, new Item[]{new Item(554, 5), new Item(564)}), ENCHANT_LV_4(57, 720, Graphic.highGraphic(115), 67, new Item[]{new Item(557, 10), new Item(564)}), ENCHANT_LV_5(68, 721, Graphic.highGraphic(116), 78, new Item[]{new Item(557, 15), new Item(555, 15), new Item(564)}), ENCHANT_LV_6(87, 721, Graphic.highGraphic(452), 97, new Item[]{new Item(557, 20), new Item(554, 20), new Item(564)}),

	TELEOTHER_LUMBRIDGE(74, 1818, Graphic.highGraphic(343), 0, new Item[]{new Item(566), new Item(563), new Item(557)}), TELEOTHER_FALADOR(82, 1818, Graphic.highGraphic(343), 0, new Item[]{new Item(566), new Item(563), new Item(555)}), TELEOTHER_CAMELOT(90, 1818, Graphic.highGraphic(343), 0, new Item[]{new Item(566, 2), new Item(563)}),
