...
public enum Spell {
	WIND_STRIKE(1, 711, Graphic.highGraphic(90), 5.5, new Item[]{new Item(556), new Item(558)}, magicHit(2, magicProjectile(91), Graphic.highGraphic(92)), true),
	WIND_BOLT(17, 711, Graphic.highGraphic(117), 13.5, new Item[]{new Item(556, 2), new Item(562)}, magicHit(9, magicProjectile(118), Graphic.highGraphic(119)), true),
	WIND_BLAST(41, 711, Graphic.highGraphic(132), 25.5, new Item[]{new Item(556, 3), new Item(560)}, magicHit(13, magicProjectile(133), Graphic.highGraphic(134)), true),
	WIND_WAVE(62, 711, Graphic.highGraphic(158), 36, new Item[]{new Item(556, 5), new Item(565)}, magicHit(17, magicProjectile(159), Graphic.highGraphic(160)), true),
	
	WATER_STRIKE(5, 711, Graphic.highGraphic(93), 7.5, new Item[]{new Item(556), new Item(558), new Item(555)}, magicHit(4, magicProjectile(94), Graphic.highGraphic(95)), true),
	WATER_BOLT(23, 711, Graphic.highGraphic(120), 16.5, new Item[]{new Item(556, 2), new Item(562), new Item(555, 2)}, magicHit(10, magicProjectile(121), Graphic.highGraphic(122)), true),
	WATER_BLAST(47, 711, Graphic.highGraphic(135), 28.5, new Item[]{new Item(556, 3), new Item(560), new Item(555, 3)}, magicHit(14, magicProjectile(136), Graphic.highGraphic(137)), true),
	WATER_WAVE(65, 711, Graphic.highGraphic(161), 37.5, new Item[]{new Item(556, 5), new Item(565), new Item(555, 7)}, magicHit(18, magicProjectile(162), Graphic.highGraphic(163)), true),
	
	EARTH_STRIKE(9, 711, Graphic.highGraphic(96), 9.5, new Item[]{new Item(556), new Item(558), new Item(557, 2)}, magicHit(6, magicProjectile(97), Graphic.highGraphic(98)), true),
	EARTH_BOLT(29, 711, Graphic.highGraphic(123), 19.5, new Item[]{new Item(556, 2), new Item(562), new Item(557, 3)}, magicHit(11, magicProjectile(124), Graphic.highGraphic(125)), true),
	EARTH_BLAST(53, 711, Graphic.highGraphic(138), 31.5, new Item[]{new Item(556, 3), new Item(560), new Item(557, 4)}, magicHit(15, magicProjectile(139), Graphic.highGraphic(140)), true),
	EARTH_WAVE(70, 711, Graphic.highGraphic(164), 40, new Item[]{new Item(556, 5), new Item(565), new Item(557, 7)}, magicHit(19, magicProjectile(165), Graphic.highGraphic(166)), true),
	
	FIRE_STRIKE(13, 711, Graphic.highGraphic(99), 11.5, new Item[]{new Item(556, 2), new Item(558), new Item(554, 3)}, magicHit(8, magicProjectile(100), Graphic.highGraphic(101)), true),
	FIRE_BOLT(35, 711, Graphic.highGraphic(126), 21.5, new Item[]{new Item(556, 3), new Item(562), new Item(554, 4)}, magicHit(12, magicProjectile(127), Graphic.highGraphic(128)), true),
	FIRE_BLAST(59, 711, Graphic.highGraphic(129), 34.5, new Item[]{new Item(556, 4), new Item(560), new Item(554, 4)}, magicHit(16, magicProjectile(130), Graphic.highGraphic(131)), true),
	FIRE_WAVE(75, 711, Graphic.highGraphic(155), 42.5, new Item[]{new Item(556, 5), new Item(565), new Item(554, 7)}, magicHit(20, magicProjectile(156), Graphic.highGraphic(157)), true),
	...
	// misc spells
	CHARGE(80, 811, Graphic.highGraphic(301), 180, new Item[]{new Item(554, 3), new Item(565, 3), new Item(556, 3)}), LOW_ALCH(21, 712, Graphic.highGraphic(112), 31, new Item[]{new Item(554, 3), new Item(561, 1)}), HIGH_ALCH(55, 713, Graphic.highGraphic(113), 65, new Item[]{new Item(554, 5), new Item(561, 1)}), TELEGRAB(33, 728, Graphic.highGraphic(142), 43, new Item[]{new Item(556, 1), new Item(563, 1)}, magicHit(-1, magicProjectile(143), new Graphic(144, 0)), false), CHARGE_WATER(56, 726, Graphic.highGraphic(149), 56, new Item[]{new Item(555, 3), new Item(564, 3)}), CHARGE_EARTH(60, 726, Graphic.highGraphic(151), 70, new Item[]{new Item(557, 3), new Item(564, 3)}), CHARGE_FIRE(63, 726, Graphic.highGraphic(152), 73, new Item[]{new Item(554, 3), new Item(564, 3)}), CHARGE_AIR(66, 726, Graphic.highGraphic(150), 75, new Item[]{new Item(556, 3), new Item(564, 3)}), BONES_TO_BANANA(15, 722, Graphic.highGraphic(141), 25, new Item[]{new Item(557, 2), new Item(555, 2), new Item(561)}), SUPERHEAT(
